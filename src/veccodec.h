...
//! IDX-ubyte format, (e.g., MNIST)
#define VECCODEC_FORMAT_IDX3_UBYTE      0x060000
//! IDX-ubyte format, (e.g., MNIST)
#define VECCODEC_FORMAT_IDX1_UBYTE      0x060001
...
/*!
 * Save a csv file, input from a double buffer.
 * This version assumes that all vectors have the same dimension.
 *
 * Save the file in a single row.
 * Should not be used for saving files twice larger than RAM.
